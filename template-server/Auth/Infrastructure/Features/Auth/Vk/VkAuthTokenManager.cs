...
namespace Infrastructure.Features.Auth.Vk;
...
public class VkAuthTokenManager
{
    ...
    public async Task<Result<string, Error>> GetVkUserId(string code, string vkDeviceId)
    {
        ...
        VkTokensResponse vkTokensResponse = JsonConvert.DeserializeObject<VkTokensResponse>(
            responseContent
        )!;

        return vkTokensResponse.UserId;
    }
}

public class VkTokensResponse
{
